...
class TextDataset(Dataset):
    def __init__(self, dataset, tokenizer, n_samples=128, text_key="text", sequence_length=2048, seed=0):
        ...
        for _ in range(n_samples):
            start_idx = random.randint(0, len(self.dataset) - sequence_length - 1)
...
class WikiTextDataModule(LightningDataModule):
    def __init__(self, directory_dataset=os.getcwd(), batch_size=1, sequence_length=2048, n_samples=128, tokenizer_name=None, seed=1):
        super().__init__()
