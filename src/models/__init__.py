...
LLAMA_3_8B_QUANTO_CALIB_8_local = "Llama-3-8B-QUANTO-CALIB-local"
LLAMA_3_8B_QUANTO_8_mixed_local = "Llama-3-8B-QUANTO-8-local"
...
MODEL_TO_TOKENIZER_MAP = {
    ...
    LLAMA_3_8B_QUANTO_8_local: META_LLAMA_3_8B,
    LLAMA_3_8B_QUANTO_CALIB_8_local: META_LLAMA_3_8B,
    LLAMA_3_8B_QUANTO_8_mixed_local: META_LLAMA_3_8B,
